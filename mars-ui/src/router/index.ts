  ...
  },
  {
    ...
    children: [
      ...
      // 店铺管理
      {
        path: 'biz/shop',
        name: 'BizShop',
        component: () => import('@/views/biz/shop/index.vue'),
        meta: { title: '店铺管理', icon: 'StorefrontOutline' }
      },
      // 激活码管理
      {
        path: 'biz/activation-code',
        name: 'BizActivationCode',
        component: () => import('@/views/biz/activation-code/index.vue'),
        meta: { title: '激活码管理', icon: 'TicketOutline' }
      },
      // 消息中心
      {
        path: 'message/notice',
